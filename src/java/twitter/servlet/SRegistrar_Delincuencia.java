 ...
 * @author ruben
 */
public class SRegistrar_Delincuencia extends HttpServlet {

    ManagerPuntos_delincuencia mp = null;
    ManagerPuntos_delincuencia managerP = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //manager adn bean
        mp = new ManagerPuntos_delincuencia(conexion);
        managerP = new ManagerPuntos_delincuencia(con);
        ...
        try {
            ...
            bp.setUsuario(mrequest.getParameter("reg_como"));
