...
import twitter.manager.ManagerPuntos_desechos;

public class SRegistrar_Desechos extends HttpServlet {

    ManagerPuntos_desechos mp = null;
    ManagerPuntos_desechos managerP = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //manager adn bean
        mp = new ManagerPuntos_desechos(conexion);
        managerP = new ManagerPuntos_desechos(con);
        ...
        String id = mp.getlast() + "w";//id=idpunto
        ...
        try {
            ...
            BPunto_Desechos bp = new BPunto_Desechos();
