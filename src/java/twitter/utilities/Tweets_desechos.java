...
public class Tweets_desechos {
    ...
    public List<BPunto_delincuencia> get_tweets(List<BPunto_delincuencia> list_in_db) { //list_in_db= listado de tweets en la base de datos
        ...
        String jsonString = callURL("https://search.twitter.com/search.json?q=%23tachito&include_entities=1&&geocode=-13.16074,-74.22563,1mi");
